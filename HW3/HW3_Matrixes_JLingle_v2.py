...
print('If the boss is paying, then cost would probably not be a factor for anybody, BUT it still may be a preference for the boss if they are expensing the meal and are within a certain budget.')
